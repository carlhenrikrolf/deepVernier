...
for currentStim = 1:length(stimSizes)
    ...
    for run = 1:nRuns
        ...
        for currentLayer = readoutLayers
            ...
            nEpochs = 1500;
            classifier = trainSoftmaxLayer(netTrainSet', netTrainAnswers', 'LossFunction', 'mse',...
                'MaxEpochs', 1, 'ShowProgressWindow', 1, 'TrainingAlgorithm', 'trainscg');
            ...
            [classifier, TR] = train(classifier,netTrainSet',netTrainAnswers');
            ...
            clear netTrainSet netTrainAnswers
