function [trainSet, testSet, trainAnswers, testAnswers] = makeUncrowdedTrainingAndTestingSampleSets(nSamples, imSize, D, T, L, nFlankerPairs)
...
[RTrainSet, RTestSet, LTrainSet, LTestSet] = createUncrowdedSampleSets(imSize, nSamples, D, T, L, dataType, nFlankerPairs);
...
% cd(sampleDir)
% save([num2str(nFlankerPairs),'PairsTrainSet'], 'trainSet')
% save([num2str(nFlankerPairs),'crowdedTestSet'], 'testSet')
% save([num2str(nFlankerPairs),'crowdedTrainAnswers'], 'trainAnswers')
% save([num2str(nFlankerPairs),'crowdedTestAnswers'], 'testAnswers')
% cd(progDir)
