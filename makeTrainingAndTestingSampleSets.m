function [trainSet, testSet, trainAnswers, testAnswers] = makeTrainingAndTestingSampleSets(nSamples, imSize, D, T, L)
...
%nSamples = 100;      % number of samples for each vernier side in each set
